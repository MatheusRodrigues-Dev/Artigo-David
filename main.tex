...
Para isso, foi realizada a avaliação heurística, método amplamente utilizado na análise de usabilidade por meio dos dez princípios de Jakob Nielsen. A avaliação utilizou um checklist semiestruturado, elaborado com base nos dez princípios heurísticos de Nielsen (1993).
